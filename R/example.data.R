...
#' @details This datasets can be applied as an example to test functions provided in this package. Other examples of ROXAS output can be obtained via: \href{http://www.wsl.ch//roxas/}{WSL - ROXAS}.
#' @export
